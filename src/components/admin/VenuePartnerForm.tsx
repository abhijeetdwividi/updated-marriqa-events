...
type VenuePartnerFormProps = {
    mode: "create" | "edit";
    initialData?: VenuePartnerFormData;
};
...
export default function VenuePartnerForm({
    ...
    const [features, setFeatures] = useState(
        featuresToText(initialData?.features),
    );
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (mode === "edit") {
                if (!initialData?.id) {
                    throw new Error("Missing venue partner ID.");
                }
