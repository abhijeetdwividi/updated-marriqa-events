        ...
        <footer>
            <div className="footer-inner">
                <div className="footer-brand">
                    <span className="footer-logo">Marriqa Events</span>

                    <p>
                        Crafting unforgettable luxury experiences across Delhi
                        NCR, Rajasthan, and Uttarakhand. Where every detail
                        tells your story.
                    </p>
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        <li>
                            <a href="#services">Luxury Weddings</a>
                        </li>
                        <li>
                            <a href="#services">Engagements</a>
                        </li>
                        <li>
                            <a href="#services">Premium Decor</a>
                        </li>
                        <li>
                            <a href="#services">Birthday Galas</a>
                        </li>
                        <li>
                            <a href="#services">Corporate Events</a>
                        </li>
                        <li>
                            <a href="#services">Destination Weddings</a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#contact">Uttarakhand</a>
                        </li>
                        <li>
                            <a href="#contact">Pan India</a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="footer-col">
                    ...
                    <a
                        href="https://wa.me/918252216549?text=Hello%20Marriqa%20Events"
                        target="_blank"
                        rel="noreferrer"
                        className="wa-btn"
            ...
            <div className="footer-bottom">
                <p>
                    © 2025 <span>Marriqa Events</span>. All rights reserved.
